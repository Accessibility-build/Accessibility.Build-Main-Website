...
export default function CognitiveAccessibilityGuidePage() {
  return (
    <>
      ...
      <GuideArticleSchema route="/guides/cognitive-accessibility" title={pageTitle} description={pageDescription} datePublished="2026-08-07" />
        ...
        <article>
          ...
          <section className="pt-12 pb-8 px-4 sm:px-6">
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <PageByline route="/guides/cognitive-accessibility" variant="hero" align="center" />
            </div>
          </section>
