...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://accessibility.build/images/tools/mobile-checker-og.png",
        width: 1200,
        height: 630,
        alt: "Mobile Accessibility Checker Interface"
      }
    ]
  },
  twitter: {
...
const breadcrumbs = [
  ...
  { name: "Mobile Accessibility Checker", url: "https://accessibility.build/tools/mobile-accessibility-checker" }
]
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
        ...
        <div className="container-wide pb-16">
          ...
          <div className="mt-16">
            <RelatedContent
              content="mobile accessibility touch targets responsive design screen readers"
