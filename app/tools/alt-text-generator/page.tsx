...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://accessibility.build/images/tools/alt-text-generator-og.png",
        width: 1200,
        height: 630,
        alt: "AI Alt Text Generator Tool Interface"
      }
    ]
  },
  twitter: {
...
const breadcrumbs = [
  ...
  { name: "AI Alt Text Generator", url: "https://accessibility.build/tools/alt-text-generator" }
]
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50/50 via-white to-purple-50/50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
        <div className="container-wide py-12">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-20">
              <RelatedContent
                content="alt text image accessibility screen readers SEO visual content"
