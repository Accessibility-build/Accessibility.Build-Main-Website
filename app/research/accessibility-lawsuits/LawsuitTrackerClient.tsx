  ...
  return (
    <div className="mx-auto max-w-7xl space-y-14 px-4 py-10 sm:px-6 md:space-y-16 md:py-14 lg:px-8">
      <MethodologySection
        ...
        dateRange="Federal trend: 2018-2025; legal developments reviewed through September 16, 2026"
        limitations={[
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <CardDescription className="mt-1">
                  Status as re-checked on September 16, 2026. Deadline extensions do not erase underlying accessibility obligations.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
