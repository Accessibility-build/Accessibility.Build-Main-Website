...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const wcagBuiltCriteria = [
    ...
    "2-4-6", "2-5-7", "2-5-8", "3-1-1", "3-2-6", "3-3-1", "3-3-2", "3-3-3", "3-3-7", "3-3-8", "4-1-2", "4-1-3", "2-4-11", "1-4-12", "1-4-13",
  ]
  const wcagRoutes: SitemapEntry[] = [
    ...
    ...wcagBuiltCriteria.map((c) => ({
      ...
      priority: c === "2-5-7" || c === "2-5-8" || c === "4-1-2" || c === "3-2-6" || c === "3-3-2" || c === "3-3-1" || c === "3-3-3" || c === "3-3-7" || c === "3-3-8" || c === "2-4-7" || c === "1-4-10" || c === "1-4-11" || c === "2-4-11" || c === "1-4-12" || c === "1-4-13" || c === "2-4-6" || c === "3-1-1" ? 0.9 : 0.88,
