...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const wcagBuiltCriteria = [
    ...
    "2-5-7", "2-5-8", "3-3-1", "3-3-2", "3-3-3", "3-3-8", "4-1-2", "4-1-3", "2-4-11",
  ]
  const wcagRoutes: SitemapEntry[] = [
    ...
    ...wcagBuiltCriteria.map((c) => ({
      ...
      priority: c === "2-5-7" || c === "2-5-8" || c === "4-1-2" || c === "3-3-2" || c === "3-3-1" || c === "3-3-3" || c === "3-3-8" || c === "2-4-7" || c === "1-4-11" || c === "2-4-11" ? 0.9 : 0.88,
