...
import { Play, Pause, Square, AlertTriangle, Eye, EyeOff, RotateCcw } from 'lucide-react';
    ...
    badFlashInterval.current = setInterval(() => {
      ...
      if (badFlashElement.current) {
        badFlashElement.current.style.backgroundColor = 
          badFlashElement.current.style.backgroundColor === 'rgb(255, 0, 0)' ? 'rgb(255, 255, 255)' : 'rgb(255, 0, 0)';
      }
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-red-700 mb-4">
                  This demonstration includes flashing content that may potentially trigger seizures 
                  in individuals with photosensitive epilepsy. The examples are designed to be educational 
                  and stay within safe limits, but please use caution.
                </p>
                <p className="text-red-700 mb-4">
                  If you have a history of seizures or photosensitive epilepsy, please skip the interactive demos.
                </p>
                <button
          ...
          <>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {/* Safe Flash Demo */}
                <div>
                  <h3 className="text-lg font-semibold text-green-800 mb-4">✅ Safe Flash Rate (2 Hz)</h3>
                  <div 
                    className={`w-full h-48 border-2 border-gray-300 rounded-lg flex items-center justify-center text-center transition-all duration-100 ${
                      isFlashing && flashCount % 2 === 0 ? 'bg-orange-100' : 'bg-white'
                    }`}
                  >
                    <div>
                      <div className="text-2xl font-bold text-gray-700 mb-2">Safe Flash Demo</div>
                  ...
                  <div className="mt-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-700">Flash Count:</span>
                      <span className="text-lg font-bold text-orange-600">{flashCount}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-700">Elapsed Time:</span>
                      <span className="text-lg font-bold text-orange-600">{elapsedTime.toFixed(1)}s</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-700">Rate:</span>
                      <span className="text-lg font-bold text-green-600">
                        {elapsedTime > 0 ? (flashCount / elapsedTime).toFixed(1) : 0} Hz
                      </span>
                    </div>
                  </div>
                ...
                {/* Flash Rate Control */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Flash Rate Control</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-red-800 font-medium mb-2">
                      ⚠️ This example demonstrates unsafe flashing that violates WCAG 2.3.1
                    </p>
                    <p className="text-red-700 text-sm">
                      Limited to 3 seconds duration for safety. This rate (5 Hz) could trigger seizures.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-lg font-semibold text-red-800 mb-4">❌ Unsafe Flash Rate (5 Hz)</h3>
                  <div 
                    ref={badFlashElement}
                  ...
                  >
                    <div>
                      <div className="text-2xl font-bold text-gray-700 mb-2">UNSAFE Example</div>
                  ...
                  <div className="mt-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-700">Flash Count:</span>
                      <span className="text-lg font-bold text-red-600">{badFlashCount}</span>
                    </div>
                  </div>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Why This Fails</h3>
                  <div className="space-y-4">
                    <div className="p-4 bg-red-50 rounded-lg">
                      <h4 className="font-semibold text-red-900 mb-2">Violations:</h4>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  <h4 className="font-semibold text-blue-900 mb-2">Visual Inspection</h4>
                  <ul className="text-sm text-blue-800 space-y-1">
                ...
                <div className="p-4 bg-green-50 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">Timing Analysis</h4>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-purple-50 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">Tools & Scripts</h4>
