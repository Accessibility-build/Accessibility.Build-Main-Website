...
export const metadata: Metadata = {
  ...
  description:
    clampDescription("Complete guide to WCAG 1.4.11 Non-text Contrast. Learn the 3:1 rule for user interface components and graphical objects: button borders, input outlines, focus indicators, toggle states, icons, and chart elements — with exceptions, code examples, testing methods, and common mistakes."),
  keywords: [
    "WCAG 1.4.11",
    "Non-text Contrast",
    "3:1 contrast",
  ...
  return (
    <>
      ...
      <ArticleStructuredData
        ...
        dateModified={getRouteDate("/wcag/1-4-11") ?? "2026-06-28"}
      ...
      <div className="min-h-screen pt-12 bg-white dark:bg-slate-950">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <header className="mb-12">
            ...
            <PageByline route="/wcag/1-4-11" source={{ label: "W3C: Understanding 1.4.11", href: "https://www.w3.org/WAI/WCAG22/Understanding/non-text-contrast.html" }} className="mb-5" />
