...
export const metadata: Metadata = {
  ...
  description:
    clampDescription("Complete guide to WCAG 3.2.4 Consistent Identification. Why same-function components need consistent labels, icons, and alt text across pages, plus how to test."),
  keywords: [
    "WCAG 3.2.4",
  ...
  return (
    <>
      ...
      <ArticleStructuredData
        ...
        dateModified={getRouteDate("/wcag/3-2-4") ?? "2026-07-09"}
      ...
      <div className="min-h-screen pt-12 bg-white dark:bg-slate-950">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <header className="mb-12">
            ...
            <PageByline route="/wcag/3-2-4" source={{ label: "W3C: Understanding 3.2.4", href: "https://www.w3.org/WAI/WCAG22/Understanding/consistent-identification.html" }} className="mb-5" />
