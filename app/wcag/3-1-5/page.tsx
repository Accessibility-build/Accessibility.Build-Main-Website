...
export const metadata: Metadata = {
  ...
  description:
    clampDescription("Guide to WCAG 3.1.5 Reading Level: the lower secondary education benchmark, Flesch-Kincaid and other readability scores, supplemental content, and how to test."),
  keywords: [
    "WCAG 3.1.5",
    "Reading Level",
      ...
      <div className="min-h-screen pt-12 bg-white dark:bg-slate-950">
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <header className="mb-12">
            ...
            <PageByline route="/wcag/3-1-5" source={{ label: "W3C: Understanding 3.1.5", href: "https://www.w3.org/WAI/WCAG22/Understanding/reading-level.html" }} className="mb-5" />
