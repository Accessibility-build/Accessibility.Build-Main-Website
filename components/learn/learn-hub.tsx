...
interface LearnHubProps {
  /** Server-rendered content slotted between the pattern cards and the Coming Soon section. */
  afterPatterns?: React.ReactNode;
}

export function LearnHub({ afterPatterns }: LearnHubProps) {
