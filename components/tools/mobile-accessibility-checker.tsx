...
Report generated by Accessibility.build Mobile Checker
  ...
  const downloadResults = () => {
    ...
    const payload = {
      ...
      url,
      notice: "Automated mobile checks require manual verification on real devices and assistive technologies.",
      results,
    }
    ...
    anchor.href = href
    anchor.download = "mobile-accessibility-scan.json"
    anchor.click()
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <h2 className="sr-only">Mobile accessibility scan workspace</h2>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Scan a public page for mobile touch targets, viewport behavior, responsive layout, and automated accessibility findings
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={selectedDevice} onValueChange={setSelectedDevice}>
                <SelectTrigger className="bg-background" aria-label="Test device">
