        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
              Professional accessibility platform with AI-powered tools, WCAG compliance testing, and comprehensive resources for building inclusive digital experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { href: "/tools/accessibility-audit-helper", label: "Accessibility Auditor", badge: "Pro" },
                { href: "/tools/alt-text-generator", label: "AI Alt Text Generator", badge: "Popular" },
                { href: "/tools/contrast-checker", label: "Contrast Checker", badge: "Free" },
                { href: "/tools/heading-analyzer", label: "Heading Analyzer", badge: "Free" },
                ...
                <li key={index}>
                  ...
                  >
                    ...
                    {item.badge && (
                      <Badge variant={item.badge === 'Free' ? 'secondary' : item.badge === 'Popular' ? 'default' : 'outline'} className="text-xs ml-2">
                        {item.badge}
                      </Badge>
                    )}
                  </Link>
        ...
        <div className="mt-12 pt-8 border-t border-slate-200/50 dark:border-slate-700/50">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4 text-sm text-muted-foreground">
              <p>&copy; {currentYear} Accessibility.build</p>
              <span className="hidden md:inline">•</span>
              <p className="flex items-center">
                Made with <Heart className="h-3 w-3 mx-1 text-red-500" /> for inclusive web
              </p>
            </div>
