...
export const keyRulings: KeyRuling[] = [
  ...
  },
  {
    ...
    court: "Supreme Court (Cert Denied)",
    summary: "Supreme Court declined to hear Domino's appeal, letting stand the 9th Circuit ruling that the ADA applies to its website and app",
    significance: "A denial of certiorari sets no precedent of its own; it left the 9th Circuit nexus holding in force",
    outcome: "plaintiff",
    type: "Court decision",
  },
  {
    ...
    court: "11th Circuit (Vacated)",
    summary: "A panel held Winn-Dixie's website was not a place of public accommodation, then the court vacated that opinion as moot on December 28, 2021",
    significance: "Because the opinion was vacated it binds no one; the 11th Circuit has no controlling website-accessibility holding",
    outcome: "defendant",
    type: "Court decision",
  },
  {
