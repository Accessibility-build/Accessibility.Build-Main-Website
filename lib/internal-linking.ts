...
const MORE_LINKS: InternalLink[] = [
  ...
  { url: "/guides/accessible-notifications", title: "Accessible Notifications & Toasts Guide", description: "A toast asks a screen reader user to hear a message and act on it before it disappears, and those two demands pull against each other. Covers the two questions that pick the pattern, the live region that has to exist before the message does, the role=status versus role=alert politeness fork, why auto-dismiss collides with WCAG 2.2.1 Timing Adjustable, why a toast must never take focus, stacking and queueing without flooding, status that never depends on color alone, and how to test with a screen reader. Copy-ready HTML, JavaScript, and React mapped to WCAG 4.1.3 Status Messages", type: "guide", keywords: ["accessible notifications", "accessible toast", "toast accessibility", "accessible toast notification", "aria-live toast", "role status vs role alert", "snackbar accessibility", "aria-live polite vs assertive", "accessible notification react", "screen reader notification", "toast wcag", "wcag 4.1.3", "status messages", "live region toast", "auto dismiss accessibility", "notification focus management", "accessible alert banner", "react toast accessibility", "aria live region not announcing", "toast screen reader not reading"], priority: 8 },
  ...
  { url: "/checklists/en-301-549", title: "EN 301 549 Interactive Checklist", description: "Every requirement of EN 301 549 v3.2.1 in plain language: 285 trackable requirements across web, documents, software, and hardware, with WCAG 2.1 cross-links, product-type scopes, void slots explained, notes, progress tracking, and Excel export for EAA and Web Accessibility Directive audits", type: "checklist", keywords: ["en 301 549 checklist", "en 301 549 requirements", "en 301 549 excel", "eaa checklist", "european accessibility act checklist", "ict accessibility checklist", "en 301 549 audit", "en 301 549 wcag mapping"], priority: 9 },
  ...
  // Case studies
  { url: "/cases", title: "Accessibility Case Studies", description: "Sourced studies of the litigation that shaped web accessibility law", type: "resource", keywords: ["case study", "case studies", "accessibility lawsuit", "litigation analysis", "legal case"], priority: 8 },
  { url: "/cases/robles-v-dominos", title: "Robles v. Domino's Pizza", description: "The landmark US web accessibility case: what broke, how it was defended, and what it cost", type: "resource", keywords: ["robles", "dominos", "domino's pizza", "dominos lawsuit", "ada lawsuit", "supreme court accessibility", "nexus test", "ada title iii case", "web accessibility lawsuit"], priority: 9 },
  // Research + reference
